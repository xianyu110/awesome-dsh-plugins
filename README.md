...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-20 21:48。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5152 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
...
| 13 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 138 | Three-tier memory control plane for DeepSeek Harness: p… |
