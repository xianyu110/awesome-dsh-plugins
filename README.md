...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-16 10:57。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3108 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1469 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
| 3 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1426 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 5 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 440 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
...
| 8 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 182 | dsh plugin: Chrome sidebar extension that lets DSH oper… |
| 9 | [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 182 | dsh-tianshu-tui — 是官方 Dsh web端的交互式终端极简风格 UI 插件。以自研ansi为… |
| 10 | [whale-girl](https://github.com/vlln/whale-girl) | 182 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
| 11 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 122 | GenUI for DeepSeek Harness: interactive UI components r… |
...
| 17 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 44 | Cross-agent, local-first persistent memory plugin for D… |
