...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 10:14。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3918 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1863 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 |
| 3 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1755 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 4 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 612 | Open-source CMA-compatible agent runtime for any model,… |
...
| 7 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 236 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
...
| 11 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 169 | GenUI for DeepSeek Harness: interactive UI components r… |
...
| 14 | [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 69 | 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可… |
| 15 | [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 68 | DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotati… |
| 16 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 67 | Three-tier memory control plane for DeepSeek Harness: p… |
