...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 21:02。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4873 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
...
| 4 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 624 | Open-source CMA-compatible agent runtime for any model,… |
...
| 7 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 324 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
| 8 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 257 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
| 9 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 249 | GenUI for DeepSeek Harness: interactive UI components r… |
