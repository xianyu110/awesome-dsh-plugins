...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 05:05。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5457 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2591 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
...
| 6 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 530 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
...
| 15 | [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 133 | Connect DSH to your database for conversational data an… |
