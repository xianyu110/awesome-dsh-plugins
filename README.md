...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-21 18:02。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5411 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2571 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
...
| 13 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 162 | Three-tier memory control plane for DeepSeek Harness: p… |
| 14 | [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 137 | The DeepSeek Harness plugin for OpenPencil — preview, i… |
