...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-20 22:32。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5154 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2463 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 ｜ Open si… |
...
| 8 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 267 | GenUI for DeepSeek Harness: interactive UI components r… |
| 9 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 255 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
| 10 | [whale-girl](https://github.com/vlln/whale-girl) | 253 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
