...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 16:57。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5577 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2650 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 3 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2306 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 9 | [whale-girl](https://github.com/vlln/whale-girl) | 268 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
...
| 13 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 176 | Three-tier memory control plane for DeepSeek Harness: p… |
| 14 | [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 151 | Connect DSH to your database for conversational data an… |
| 15 | [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 144 | The DeepSeek Harness plugin for OpenPencil — preview, i… |
