...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 11:29。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5514 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2619 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 3 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2289 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 7 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 385 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
| 8 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 293 | GenUI for DeepSeek Harness: interactive UI components r… |
...
| 14 | [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 149 | Connect DSH to your database for conversational data an… |
