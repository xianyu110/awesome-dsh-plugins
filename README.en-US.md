...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-16 07:35。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 2955 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1410 | 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理 |
| 3 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 1372 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 7 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 203 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
| 8 | [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 181 | dsh-tianshu-tui — 是官方 Dsh web端的交互式终端极简风格 UI 插件。以自研ansi为… |
| 9 | [whale-girl](https://github.com/vlln/whale-girl) | 180 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
| 10 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 177 | dsh plugin: Chrome sidebar extension that lets DSH oper… |
| 11 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 117 | GenUI for DeepSeek Harness: interactive UI components r… |
| 12 | [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 100 | 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · … |
| 13 | [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 91 | The DeepSeek Harness plugin for OpenPencil — preview, i… |
